...
class TestInitCommand:
    ...
    def test_init_with_custom_workflow_dir(self) -> None:
    ...
    def test_init_prevents_overwrite_without_force(self) -> None:
...
class TestTemplateScaffolding:
    ...
    def test_agent_templates_are_created(self) -> None:
    ...
    def test_claude_context_file_created(self) -> None:
    ...
    def test_task_log_initialized(self) -> None:
