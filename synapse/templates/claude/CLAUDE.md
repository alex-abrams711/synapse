# Synapse Agent Workflow System - {{project_name}}

**Project**: {{project_name}}
**Synapse Version**: {{synapse_version}}
...
### Core Workflow Data
- **`{{workflow_dir}}/config.yaml`** - Project configuration and agent settings
- **`{{workflow_dir}}/task_log.json`** - Complete task activity log and agent communication
- **`{{workflow_dir}}/workflow_state.json`** - Current workflow execution state
...
The system maintains a comprehensive task log in `{{workflow_dir}}/task_log.json` with entries like:
